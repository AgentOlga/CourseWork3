package olga.sockswebshop.controller;

import olga.sockswebshop.controller.dto.*;
...
import olga.sockswebshop.model.Size;
    ...
    @Tag(name = "API для учета носков", description = "Регистрация приема товара, " +
        "отпуск со склада, " +
        "списание брака, подсчет " +
        "количества товара")
    ...
    public ResponseEntity<ResponseDto>issuance(@RequestBody SocksBatch socksBatch) {
        ...
        return ResponseEntity.ok(new ResponseDto(socksCount + "носки успешно отпущены со склада."));
    }
    @GetMapping
    ...
    public ResponseEntity<ResponseDto> getCount(@RequestParam Color color,
        ...
        return ResponseEntity.ok(new ResponseDto("Количество носок" + socksCount));
    }
    @DeleteMapping
    ...
    public ResponseEntity<ResponseDto> reject(@RequestBody SocksBatch socksBatch) {
        ...
        return ResponseEntity.ok(new ResponseDto(socksCount + "носков списано со склада как брак"));
    }
